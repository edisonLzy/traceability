...
export function PendingMessages({ sessionId }: { sessionId: string }) {
  ...
  return (
    <section className="mb-2 flex max-h-20 items-start gap-2 overflow-hidden rounded-[10px] border border-warning/20 bg-warning/[0.07] px-2.5 py-2 shadow-glass-sm backdrop-blur-xl">
