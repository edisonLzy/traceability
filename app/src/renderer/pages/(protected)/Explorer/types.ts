...
export type YoutubeNodeData = Extract<ExplorerNodeData, { kind: "youtube" }>;
export type YoutubeBookmark = NonNullable<YoutubeNodeData["bookmarks"]>[number];
export type BrowserNodeData = Extract<ExplorerNodeData, { kind: "browser" }>;
export type BrowserAnchor = NonNullable<BrowserNodeData["anchors"]>[number];
export type BrowserProjection = NonNullable<BrowserNodeData["projection"]>;
export type ProjectionRule = NonNullable<BrowserProjection["rules"]>[number];
export type BrowserLocator = NonNullable<BrowserAnchor["locators"]>[number];
export type BrowserSource = BrowserNodeData["source"];
export type BrowserPreview = NonNullable<BrowserNodeData["preview"]>;
export type BrowserViewState = NonNullable<BrowserNodeData["viewState"]>;
export type BrowserProvider = BrowserSource["provider"];
export type BrowserResolution = NonNullable<BrowserAnchor["lastResolution"]>;
