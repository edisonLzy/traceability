...
import { IngestRequestError } from "../modules/ingest/index.js";

const registerErrors: FastifyPluginAsync = async (app) => {
...
export const errorHandlerPlugin = fastifyPlugin(registerErrors, {
  name: "error-handler",
});
